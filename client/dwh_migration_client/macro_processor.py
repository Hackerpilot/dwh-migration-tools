...
class MacroProcessor:
    ...
    def __init__(self, macro_argument: Namespace, expander: MacroExpanderRouter) -> None:

        self.expander = expander
        mappings = _parse_macros_config_file(macro_argument.macros)
        for glob, mapping in mappings.items():
            expander.all_macros[glob].mapping = mapping
...
def _parse_macros_config_file(yaml_file_path: str) -> Dict[str, Dict[str, str]]:
